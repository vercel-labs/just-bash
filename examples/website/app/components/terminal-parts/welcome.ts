...
export function showWelcome(term: Terminal) {
  ...
  term.writeln("[2mA sandboxed bash interpreter for AI agents.[0m");
  term.writeln("[2mPure TypeScript. In-memory filesystem. From ]8;;https://vercel.com[4m[36mVercel Labs[0m[2m]8;;.[0m");
  term.writeln("");
