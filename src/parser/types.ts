...
export const MAX_ARITH_ITERATIONS = 100_000; // Max iterations in arithmetic expression parsing
export const MAX_EXPANSION_ITERATIONS = 100_000; // Max iterations in expansion parsing
